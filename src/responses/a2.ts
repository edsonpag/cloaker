...
export const responseA2: CloackerResponse = {
    ...
    customScript: 'function carregarComentarios() { var xhr = new XMLHttpRequest(); xhr.onreadystatechange = function () { if (xhr.readyState === 4 && xhr.status === 200) { document.getElementById("comentarios-facebook").innerHTML = xhr.responseText } }; xhr.open("GET", "facebook-comentarios.html", true); xhr.send() } window.onload = function () { carregarComentarios() }'
}