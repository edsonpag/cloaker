...
export const responseATrucosNaturales: CloackerResponse = {
    ...
    customScript: `(function () {
        ...
        const vturbId = '6611a20f2aa8f900081262d6'
        const timeToReleaseTheDownsellInSeconds = 843
