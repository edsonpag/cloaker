...
import { CloackerSettingsLegacy } from "../interfaces/cloakerSettingsLegacy.interface"

export class CloackerUtilsLegacy {

    cloackerSettings: CloackerSettingsLegacy

    errors: CloackerError[] = []

    constructor(cloackerSettings: CloackerSettingsLegacy) {
